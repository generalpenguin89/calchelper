...
public class CalcGUI extends JPanel
{
	...
	// ------------------- constructor -------------------------------
	/**
	 * Container parent of the control panel is passed as an argument along with
	...
	/**
	 * JMenuItemListener handles all JMenuItem events and passes them along to
	 * methods of the GUIProcessor class.
	 */
